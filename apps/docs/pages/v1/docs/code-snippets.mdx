...
Some of the snippets are implemented in the example project. You can check them out in the [source code](https://github.com/sseuniverse/next-admin/tree/master/apps/example).
...
- [app/api/users/export/route.ts](https://github.com/sseuniverse/next-admin/tree/master/apps/example/app/api/users/export/route.ts)
- [app/api/posts/export/route.ts](https://github.com/sseuniverse/next-admin/tree/master/apps/example/app/api/posts/export/route.ts)
...
- [app/components/inputs/DatePicker.tsx](https://github.com/sseuniverse/next-admin/blob/master/apps/example/components/DatePicker.tsx)
