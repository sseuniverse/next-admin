...
<Cards>
  ...
  <Card
    icon={<PlayCircleIcon />}
    title="Live demo"
    href="https://sse-neadmin-demo.vercel.app/admin"
  />
  <Card
...
Get started by following the [installation guide](/docs/getting-started), or check out the [live demo](https://sse-neadmin-demo.vercel.app/admin).
...
If you want to request a feature, please open an issue [here](https://github.com/sseuniverse/next-admin/issues/new/choose)
